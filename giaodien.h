...
namespace giaodien {
    ...
    inline void FormThemDocGiaTUI(DocGiaNode*& Root) {
        ...
        while (true) {
            ...
            HoNhap = CatKhoangTrangHaiDau(HoNhap);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
            if (!HoNhap.empty() && KiemTraTenHopLe(HoNhap)) {
                break;
            }
            tui::DiChuyenConTro(X0, FooterY - 2);
        ...
        while (true) {
            ...
            TenNhap = CatKhoangTrangHaiDau(TenNhap);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
            if (!TenNhap.empty() && KiemTraTenHopLe(TenNhap)) {
                break;
            }
            tui::DiChuyenConTro(X0, FooterY - 2);
            tui::DatMau(tui::MauCanhBao);
        ...
        int TrangThaiNhap = 1;
        bool ThemThanhCong = ThemDocGia(Root, MaTheCanXuLy, HoNhap, TenNhap, PhaiNhap, TrangThaiNhap);
        tui::DiChuyenConTro(X0, FooterY - 2);
        if (ThemThanhCong) {
    ...
    inline void FormSuaDocGiaTUI(DocGiaNode*& Root) {
        ...
        while (true) {
            ...
            InHo = CatKhoangTrangHaiDau(InHo);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
        ...
        while (true) {
            ...
            InTen = CatKhoangTrangHaiDau(InTen);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
        ...
        bool CapNhatThanhCong = CapNhatThongTinDocGia(Root, MaTheCanXuLy, InHo, InTen, NewPhai, NewTrangThai);
        tui::DiChuyenConTro(X0, FooterY - 2);
    ...
    inline void FormThemDauSachTUI(DanhSachDauSach& DanhSachDauSach) {
        ...
        while (true) {
            ...
            TacGiaNhap = CatKhoangTrangHaiDau(TacGiaNhap);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
            if (TacGiaNhap.empty()) {
                tui::DiChuyenConTro(X0, FooterY - 2);
        ...
        while (true) {
            ...
            int GiaTriCanThem = 0;
            try {
                GiaTriCanThem = std::stoi(ChuoiNhap);
            }
            catch (...) {
                GiaTriCanThem = 0;
            }
        ...
        while (true) {
            ...
            TheLoaiNhap = CatKhoangTrangHaiDau(TheLoaiNhap);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
            if (TheLoaiNhap.empty()) {
                tui::DiChuyenConTro(X0, FooterY - 2);
                tui::DatMau(tui::MauCanhBao);
                std::cout << "The loai khong duoc de trong.";
                tui::DatLaiMau();
                XoaDongTaiViTri(TlX, TlY, 48);
                continue;
            }
        ...
        while (true) {
            ...
            KeNhap = CatKhoangTrangHaiDau(KeNhap);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
            if (KeNhap.empty()) {
                tui::DiChuyenConTro(X0, FooterY - 2);
    ...
    inline void FormXoaDauSachTUI(DanhSachDauSach& DanhSachDauSach) {
        const int ChieuRong = 100;
        const int ChieuCao = 22;
        const int X0 = 4;
        const int Y0 = 3;
        const int FooterY = 1 + ChieuCao - 2;
        tui::XoaManHinh();
        ...
        int TongSoBanSao = DemTongSoBanSao(DuLieuSach);
        int SoSachDangMuon = DemSoSachDangMuon(DuLieuSach);
        Y += 2;
        tui::DiChuyenConTro(X0, Y++);
        std::cout << "Ten sach              : " << DuLieuSach->TenSach;
        tui::DiChuyenConTro(X0, Y++);
        std::cout << "Tong so ban sao       : " << TongSoBanSao;
        tui::DiChuyenConTro(X0, Y++);
        std::cout << "So ban sao dang muon  : " << SoSachDangMuon;
        // ISBN được giữ lại từ lần xóa bản sao cuối trước đó
        if (TongSoBanSao == 0) {
            Y += 2;
            tui::DiChuyenConTro(X0, Y);
            std::cout << "ISBN nay hien khong con ban sao. " << "Xoa ISBN: ";
            int LuaChonXoaISBN = ChonRadioTaiViTri(X0 + 47, Y, { "Co", "Khong" }, 1);
            if (LuaChonXoaISBN != 0) {
                tui::DiChuyenConTro(X0, FooterY - 2);
                std::cout << "Da huy xoa ISBN.";
                tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
                return;
            }
            tui::DiChuyenConTro(X0, FooterY - 2);
        ...
        Y += 2;
        tui::DiChuyenConTro(X0, Y);
        std::cout << "Nhap ma ban sao can xoa: ";
        int MaSachX = X0 + 25;
        int MaSachY = Y;
        std::string MaSachCanXoa;
        if (DocDongChoPhepThoatKhiRong(MaSachX, MaSachY, MaxMaSach - 1, MaSachCanXoa) == -1) {
            return;
        }
        MaSachCanXoa = CatKhoangTrangHaiDau(MaSachCanXoa);
        DanhMucSachNode* BanSaoCanXoa = TimSachTheoMaSach(DuLieuSach, MaSachCanXoa.c_str());
        if (BanSaoCanXoa == NULL) {
            tui::DiChuyenConTro(X0, FooterY - 2);
            tui::DatMau(tui::MauCanhBao);
            std::cout << "Ma ban sao khong ton tai " << "trong ISBN nay.";
            tui::DatLaiMau();
            tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
            return;
        }
        if (BanSaoCanXoa->TrangThai == 1) {
            tui::DiChuyenConTro(X0, FooterY - 2);
            tui::DatMau(tui::MauCanhBao);
            std::cout << "Khong the xoa: " << "ban sao dang duoc muon.";
            tui::DatLaiMau();
            tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
            return;
        }
        Y += 2;
        tui::DiChuyenConTro(X0, Y);
        std::cout << "Xac nhan xoa ban sao " << MaSachCanXoa << ": ";
        int LuaChonXoaBanSao = ChonRadioTaiViTri(X0 + 38, Y, { "Co", "Khong" }, 1);
        if (LuaChonXoaBanSao != 0) {
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << "Da huy xoa ban sao.";
            tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
            return;
        }
        bool LaBanSaoCuoiCung = TongSoBanSao == 1;
        if (!XoaBanSaoTheoMaSach(DuLieuSach, MaSachCanXoa)) {
            tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
            return;
        }
        if (!LaBanSaoCuoiCung) {
            tui::DiChuyenConTro(X0, FooterY - 2);
            tui::DatMau(tui::MauThanhCong);
            std::cout << "Da xoa ban sao " << MaSachCanXoa << ".";
            tui::DatLaiMau();
            tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
            return;
        }
        Y += 2;
        tui::DiChuyenConTro(X0, Y);
        std::cout << "Da xoa ban sao cuoi. " << "Ban co muon xoa ISBN: ";
        int LuaChonXoaISBN = ChonRadioTaiViTri(X0 + 47, Y, { "Co", "Khong" }, 1);
        tui::DiChuyenConTro(X0, FooterY - 2);
        if (LuaChonXoaISBN == 0) {
            if (XoaDauSach(DanhSachDauSach, ISBNCanXuLy)) {
                tui::DatMau(tui::MauThanhCong);
                std::cout << "Da xoa ban sao cuoi " << "va xoa ISBN.";
            }
        }
        else {
            tui::DatMau(tui::MauThanhCong);
            std::cout << "Da xoa ban sao cuoi. " << "ISBN van duoc giu lai.";
        }
        tui::DatLaiMau();
        tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
    }
    ...
    inline void VeBangThongTinCuDauSach(const DauSach& DauSachCanHienThi, int X, int Y, int ChieuRong, int ChieuCao) {
        ...
        tui::DiChuyenConTro(X + 2, DongHienTai++);
        std::cout << "Sach dang muon : " << CanLeTrai(std::to_string(DemSoSachDangMuon(&DauSachCanHienThi)), DoRongGiaTri);
    }
    ...
    inline void FormCapNhatDauSachTUI(DanhSachDauSach& DanhSachDauSach) {
        ...
        if (ISBNCanXuLy.empty()) {
            tui::DiChuyenConTro(X0, FooterY - 2);
            tui::DatMau(tui::MauCanhBao);
            std::cout << "ISBN khong duoc de trong.";
            tui::DatLaiMau();
            tui::NhanPhimBatKyDeQuayLai(4, FooterY - 1);
            return;
        }
        ...
        while (true) {
            ...
            InTG = CatKhoangTrangHaiDau(InTG);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
            if (InTG.empty()) {
                break;
        ...
        while (true) {
            ...
            InKe = CatKhoangTrangHaiDau(InKe);
            tui::DiChuyenConTro(X0, FooterY - 2);
            std::cout << std::string(90, ' ');
            if (InKe.empty()) {
                if (DuLieuSach->SoLuongBanSao == 0 && HasSL == 1 && SlTarget > 0) {
                    tui::DiChuyenConTro(X0, FooterY - 2);
                    tui::DatMau(tui::MauCanhBao);
                    std::cout << "ISBN khong con ban sao, bat buoc nhap ke de tao ban sao moi.";
                    tui::DatLaiMau();
                    XoaDongTaiViTri(KeX, KeY, 20);
                    continue;
                }
        ...
        bool CapNhatThanhCong = CapNhatThongTinDauSach(DanhSachDauSach, ISBNCanXuLy, InTen, InTG, InNam, InST, InKe, HasSL, SlTarget);
        tui::DiChuyenConTro(X0, FooterY - 2);
        tui::XoaVung(BangX, BangY, BangRong, BangCao);
        tui::DiChuyenConTro(X0, FooterY - 2);
        if (CapNhatThanhCong) {
